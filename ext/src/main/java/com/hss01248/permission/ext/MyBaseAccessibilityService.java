 ...
 * @Version 1.0
 */
public class MyBaseAccessibilityService extends AccessibilityService {

   public static  String topAppName = "";

   //todo LiveData<AccessibilityEvent> 然后外面就可以任意监听了
    @Override
    ...
    public static boolean isAccessibilityServiceEnabled( ) {
        return  isAccessibilityServiceEnabled(MyBaseAccessibilityService.class);
    }
